...
static {
countries.put(14,   new Country(14,   "India",      13784745,   82046000L,  parseDate("30-nov-2008"),   "INR"));
countries.put(48,   new Country(48,   "Pakistan",        92098,    23837000L,  null,                       "Pakistani Rupee"));
countries.put(53,   new Country(53,   "Australia",    2966200,  21884000L,  parseDate("04-sep-2009"),   "Australian Dollar"));
countries.put(73,   new Country(73,   "USA",       50949,    11257285L,  parseDate("1-jan-2009"),    "Dollar"));
countries.put(122,  new Country(122,  "Singapore",      26900,    4382100L,   parseDate("1-jan-2009"),    "singapore dollar"));
countries.put(123,  new Country(123,  "New Zealand",  104454,   4320300L,   parseDate("4-sep-2009"),    "New Zealand Dollar"));
countries.put(147,  new Country(147,  "Thailand",       4361,     1705000L,   null,                       "Thai Baht"));
countries.put(149,  new Country(149,  "Nepal",        103347,   1475000L,   null,                       "Nepalese rupee"));
}
